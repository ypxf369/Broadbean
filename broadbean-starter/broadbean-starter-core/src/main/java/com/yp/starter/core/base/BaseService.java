...
import com.yp.starter.core.constants.Constants;
import com.yp.starter.core.exception.UpdateFailedException;
import com.yp.starter.core.util.Reflections;
...
public abstract class BaseService<T> implements Service<T> {
    ...
    @Override
    public List<T> select(T record, int pageIndex, int pageSize) {
